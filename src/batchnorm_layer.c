...
void forward_batchnorm_layer2(layer l, float* input){
    if(l.type == BATCHNORM) copy_cpu(l.outputs*l.batch, input, 1, l.output, 1);
...
{
    if(l.type == BATCHNORM) copy_gpu(l.outputs*l.batch, input_gpu, 1, l.output_gpu, 1);
    copy_gpu(l.outputs*l.batch, l.output_gpu, 1, l.x_gpu, 1);
    // printf("norm check:0\n");
...
void backward_batchnorm_layer_gpu2(layer l, float* input_gpu)
{
    ...
    normalize_delta_gpu(l.x_gpu, l.mean_gpu, l.variance_gpu, l.mean_delta_gpu, l.variance_delta_gpu, l.batch, l.out_c, l.out_w*l.out_h, l.delta_gpu);
#endif
    if(l.type == BATCHNORM) copy_gpu(l.outputs*l.batch, l.delta_gpu, 1, input_gpu, 1);
}
